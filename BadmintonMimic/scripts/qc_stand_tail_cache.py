...
def main() -> int:
    ...
    parser.add_argument("--manifest", type=Path, default=Path("BadmintonMimic/manifests/10trajectories_smooth_27_stand_tail_list.txt"))
    parser.add_argument("--cache-root", type=Path, default=Path("caches/AMASS/MyoFullBody/gmr"))
    parser.add_argument("--output-csv", type=Path, default=Path("BadmintonMimic/outputs/qc/stand_tail_qc.csv"))
    parser.add_argument("--output-json", type=Path, default=Path("BadmintonMimic/outputs/qc/stand_tail_qc_summary.json"))
