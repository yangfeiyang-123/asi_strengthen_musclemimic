...
export MUSCLEMIMIC_AMASS_PATH="${MUSCLEMIMIC_AMASS_PATH:-${BADMINTONMIMIC_ROOT}/data/amass_npz}"
export AMASS_PATH="${MUSCLEMIMIC_AMASS_PATH}"

export MUSCLEMIMIC_CONVERTED_AMASS_PATH="${MUSCLEMIMIC_CONVERTED_AMASS_PATH:-${MUSCLEMIMIC_ROOT}/caches/AMASS}"
