...
def _build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--manifest", type=Path, default=Path("manifests/10trajectories_smooth_27_list.txt"))
    ...
    parser.add_argument("--output-manifest", type=Path, default=Path("manifests/10trajectories_smooth_27_stand_tail_list.txt"))
